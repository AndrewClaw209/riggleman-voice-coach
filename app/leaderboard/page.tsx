  ...
  return <main className="min-h-[100dvh] bg-slate-900 text-white">
    ...
    <div className="mx-auto max-w-5xl space-y-6 px-4 py-6 sm:px-8 sm:py-10">
      <section className="rounded-2xl border border-[#c58b2a]/50 bg-gradient-to-br from-slate-800 to-slate-900 p-5 shadow-[0_12px_36px_rgba(197,139,42,0.12)] sm:p-7">
        <p className="text-sm font-semibold uppercase tracking-wider text-[#f2cd7f]">Social challenge</p><h2 className="mt-2 text-2xl font-bold">Compete on your best call</h2><p className="mt-2 max-w-xl text-sm leading-6 text-slate-300">Every completed scorecard contributes to the community leaderboard. We publish your display name, best score, average score, and completed session count; transcripts and coaching notes stay private.</p>
        <p className="mt-4 text-sm text-emerald-300">{currentRank > 0 ? `You are ranked #${currentRank}.` : 'Complete a scored session to enter the rankings.'}</p>
      </section>
